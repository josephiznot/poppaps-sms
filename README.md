...
- **Designated dealer**: after migration 0008, mark the dealer role separately in D1. The hourly job sends dealer-specific notice and reminder copy without using a ranked seat or requiring CALL/FOLD. Production role assignment is a separate operation.
